...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Unidentified-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.ufocoin.net", "seed2.ufocoin.net", "seed3.ufocoin.net", "seed4.ufocoin.net", "ufo.bushstar.co.uk", "dnsseed.lowecraft.it", "dnsseed.ufocoinnode.com", ""};
static const string testnet_seeds[] = {"testnet-seed.ufocoin.co", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9887), true);
  }
  do {
